...
HIERARCHY = {
    'INDUSTRIA': [],
    'SALES': [
        'BARREDURA', 'FINA', 'GANADO', 'HIDROSAL', 'LAVASAL', 
        'PHARMASAL', 'PULVERIZADA', 'REDUCIDAS EN SODIO', 'SACO AP', 'TEXTIL'
    ],
    'QUIMICOS': [
        'ACIDO CLORHIDRICO', 'ACIDO SULFONICO BRINSA', 'ACIDO SULFONICO MAQUILA',
        'CLORO', 'CLORURO DE CALCIO', 'HIPOCLORITO DE SODIO', 'SODA'
    ]
}
DISPLAY_ORDER = [
    'INDUSTRIA', 'SALES', 'BARREDURA', 'FINA', 'GANADO', 'HIDROSAL', 
    'LAVASAL', 'PHARMASAL', 'PULVERIZADA', 'REDUCIDAS EN SODIO', 
    'SACO AP', 'TEXTIL', 'QUIMICOS', 'ACIDO CLORHIDRICO', 
    'ACIDO SULFONICO BRINSA', 'ACIDO SULFONICO MAQUILA', 'CLORO', 
    'CLORURO DE CALCIO', 'HIPOCLORITO DE SODIO', 'SODA'
]
